...
# extract rules:
rules <- extract.rules(data = data.split$train.data, n.trees = 200, mtry = 30, node_depth_max = 4)
...
write.csv(selected.rules$Selected.Rules, "/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Results/Decision Rules Results July 7/binary2_rules.csv")
