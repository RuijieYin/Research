...
write.csv(rules$Rules, "F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Results/Decision Rules Results October 13/rules_extracted_exp4.csv")
...
write.csv(selected.rules$Selected.Rules, "F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Results/Decision Rules Results October 13/multiclass1_rules_selected_exp4.csv")
