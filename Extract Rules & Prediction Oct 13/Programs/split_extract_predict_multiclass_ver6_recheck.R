...
extract.rules <- function (data = data.split$train.data, n.trees = 100, mtry = 5, node_depth_max = 5) {
...
predict.rules <- function(validation.data = data.split$test.data, rule.table=rules$Rules) {
