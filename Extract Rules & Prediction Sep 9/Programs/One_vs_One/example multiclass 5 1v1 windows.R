...
# rules$Rules
write.csv(rules$Rules, "F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction September 9/rules_extracted_1v1_setup5.csv")
...
write.csv(selected.rules$Selected.Rules, "F:/Dropbox/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction September 9/multiclass1_rules_1v1_setup5.csv")
