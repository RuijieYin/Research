...
# extract rules:
rules <- extract.rules(data = training_data, n.trees = 20, mtry = 5, node_depth_max = 7)
# see all rules extracted from the n.tree trees
rules$Rules
write.csv(rules$Rules, "/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction September 9/rules_extracted_1vr_setup5.csv")
...
write.csv(selected.rules$Selected.Rules, "/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction September 9/multiclass1_rules_1vr_setup5.csv")
