...
source("/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction July 15/treeRule_Obtain_Judge.R")
# load split.extract.predict.R
source("/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction July 15/split_extract_predict_multiclass_oob_balanced.R")
...
# load split.extract.predict.R
source("F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction July 15/split_extract_predict_multiclass_oob_balanced.R")
...
# extract rules:
rules <- extract.rules(data = data.split$train.data, n.trees = 100, mtry = 5, node_depth_max = 4)
