...
source("F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction August 18/split_extract_predict_multiclass_oob_balanced_1vr.R")
...
rules$Rules
# write.csv(rules$Rules, "/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction August 18/rules_extracted.csv")
...
# write.csv(selected.rules$Selected.Rules, "/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Extract Rules & Prediction July 15/multiclass1_rules.csv")
