...
train_data = pd.read_csv(
        '/Users/jerryruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Boosting_genepairs_TNBC/Data/microarray_BRE0904_training.csv')
test_data = pd.read_csv(
        '/Users/jerryruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Boosting_genepairs_TNBC/Data/microarray_BRE0904_test.csv')
...
X_validation = X_train[X_train.index.isin(validation_index)]
