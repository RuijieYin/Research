...
train_data = pd.read_csv(
    '/Users/jerryruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Boosting_genepairs_TNBC/Model with RFA/bl2_M_train.csv')
validation_data = pd.read_csv(
    '/Users/jerryruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Boosting_genepairs_TNBC/Model with RFA/bl2_M_validation.csv')
test_data = pd.read_csv(
    '/Users/jerryruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Boosting_genepairs_TNBC/Model with RFA/bl2_M_test.csv')
...
rfa = BoostRFA(
    lgb.LGBMClassifier(),
    step=3, min_features_to_select=3, n_jobs=-1
)
...
filename = '/Users/jerryruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Boosting_genepairs_TNBC/Model with RFA/bl2_M.sav'
