...
train_data = pd.read_csv(
    '/N/slate/liyuny/shushu/Boosting_genepairs_TNBC/Model_with_RFA/bl1_bl2_train.csv')
validation_data = pd.read_csv(
    '/N/slate/liyuny/shushu/Boosting_genepairs_TNBC/Model_with_RFA/bl1_bl2_validation.csv')
...
pickle.dump(rfa, open(filename, '/N/slate/liyuny/shushu/Boosting_genepairs_TNBC/Model_with_RFA/'))
