...
for k in range(1, 21):
    train_data = pd.read_csv(
        '/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp4 boxplot/train7_{}.csv'.format(k))
    test_data = pd.read_csv(
        '/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp4 boxplot/test7_{}.csv'.format(k))
...
result_table_df.to_csv(
    '/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp13 boxplot4 multiclass RF/Results/data7_RF_tune_nodesize_mtry.csv')
