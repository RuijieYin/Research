...
learning_rate_numbers = [0.001, 0.005,0.3, 0.5, 0.7, 1, 2, 5, 8, 10]
i=1
...
for k in learning_rate_numbers:
    clf = GradientBoostingClassifier(n_estimators=100, learning_rate=k,
                                     max_depth=3, random_state=43, n_iter_no_change =500).fit(X_train, y_train)
...
result_table_df.to_csv(
    'F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp9 boxplot3/Results/Boosting_learning_rates_ver2.csv')
