...
for k in range(1, 21):
    ...
    clf = GradientBoostingClassifier(n_estimators=100, learning_rate=0.5,
                                     max_features=15, random_state=42).fit(X_train, y_train)
...
result_table_df.to_csv(
    'F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp9 boxplot3/Results/Boosting_mtry_is_15.csv')
