...
for k in range(1, 21):
    ...
    model = RandomForestClassifier(max_features = 9)
...
result_table_df.to_csv(
    'F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp9 boxplot3/Results/RF_mtry_is_9.csv')
