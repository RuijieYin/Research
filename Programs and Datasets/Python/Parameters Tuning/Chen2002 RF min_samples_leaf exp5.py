...
for k in range(1, 21):
    ...
    model = RandomForestClassifier( min_samples_leaf=0.6)
...
result_table_df.to_csv(
    'F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp9 boxplot3/Results/RF_nodesize_exp5.csv')
