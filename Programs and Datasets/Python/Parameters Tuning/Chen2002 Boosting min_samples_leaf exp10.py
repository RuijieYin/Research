...
for k in range(1, 21):
    ...
    clf = GradientBoostingClassifier(n_estimators=100, learning_rate=0.5,
                                     min_samples_leaf = 0.25, random_state=42).fit(X_train, y_train)
...
result_table_df.to_csv(
    'F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp9 boxplot3/Results/Boosting_nodesize_exp10.csv')
