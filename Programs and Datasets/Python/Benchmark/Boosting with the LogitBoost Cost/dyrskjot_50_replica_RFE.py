...
for k in range(1, 21):
    train_data = pd.read_csv(
        '/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp17 50 replica/Data/train_dyrskjot_{}.csv'.format(
            k))
    test_data = pd.read_csv(
        '/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp17 50 replica/Data/test_dyrskjot_{}.csv'.format(
            k))
...
result_table_df.to_csv(
    '/Users/ruijieyin/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp17 50 replica/Results/dyrskjot_50.csv')
