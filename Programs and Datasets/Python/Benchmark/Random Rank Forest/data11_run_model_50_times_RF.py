...
for k in range(1, 51):
    train_data = pd.read_csv(
        'F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp17 50 replica/Data/train11_{}.csv'.format(
            k))
    train_data = train_data.drop(train_data.columns[0], axis=1)
    test_data = pd.read_csv(
        'F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp17 50 replica/Data/test11_{}.csv'.format(
            k))
    ...
    print("dataset for iteration.{} is ready".format(k))
...
result_table_df.to_csv(
    'F:/Dropbox/UM Biostatistics/Research/1st Project/TNBCtype_research/Programs/Benchmarking/exp17 50 replica/Results RF/data11.results.RF.csv')
